...
export default function NewContact() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        <h1 className="font-heading text-headline-lg text-on-surface">New Contact</h1>
        <p className="mt-1 text-body-md text-brand-neutral">Add a new contact to your CRM</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3">
          <Button type="submit" loading={submitting}>Create Contact</Button>
