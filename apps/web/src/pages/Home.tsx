  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-surface">
      ...
      <div className="flex gap-4">
        ...
        <Link
          to="/dashboard"
          className="rounded border border-outline-variant bg-surface-container-lowest px-6 py-2 text-label-lg text-on-surface-variant transition-colors hover:bg-surface-container-high"
        >
          Dashboard
        </Link>
      </div>
